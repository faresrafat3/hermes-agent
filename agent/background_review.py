...
_COMBINED_REVIEW_PROMPT = (
    ...
    "MANDATORY before ANY patch/edit: call skill_view(name) on the "
    "target FIRST in this review run, then patch. The tool refuses a "
    "patch whose target was never viewed this turn — a refused patch "
    "wastes the whole review (live 2026-08-24: 7 consecutive refusals "
    "burned an entire review with zero writes landed).\n"
